...
/**
 * Plugin implementation of the 'commerce_marketplace_list_compact' formatter.
 *
 * @FieldFormatter(
 *   id = "commerce_marketplace_list_compact",
 ...
 * )
 */
class MarketplaceListCompactFormatter extends OptionsDefaultFormatter {
